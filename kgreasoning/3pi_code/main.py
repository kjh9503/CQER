...
from kgreasoning.dataloader import TrainDataset, TestDataset, SingledirectionalOneShotIterator
...
def load_data(args, tasks):
    ...
    return train_queries, train_answers, test_queries, test_answers
...
def main_helper(args):
    ...
    if args.use_pretrain == 1: # pretrain
        #pre_model = 'mf.npz'
        pre_model = 'transr.json'
        data_name = args.data_path.split('/')[1]
        args.pretrain_embedding_dir = 'data/pretrain/%s/%s' % (data_name, pre_model)
    ...
    train_queries, train_answers, test_queries, test_answers = load_data(args, tasks) 
